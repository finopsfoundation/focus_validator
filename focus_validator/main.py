...
if __name__ == '__main__':
    ...
    parser.add_argument('--override-file',
                        help='Path to the override file (YAML)')
    parser.add_argument('--output-format',
                        default='text',
                        help='Path to the output report file')
    parser.add_argument('--supported-versions',
                        action='store_true',
                        default=False,
                        help='Return the supported FOCUS versions for validation')
    parser.add_argument('--transitional',
                        action='store_true',
                        default=False,
                        help='Allow transitional rules in validation')
    parser.add_argument('--validate-version',
                        default='0.5',
                        help='Version of FOCUS to validate against')
    parser.add_argument('--rule-set-path',
    ...
    parser.add_argument('--output-destination',
                        default='console',
                        help='Where to output the rules')

    args = parser.parse_args()
    validator = Validator(data_filename=args.data_file,
